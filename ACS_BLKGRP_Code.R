...
# Creating Census Block Groups Data File for Boston Research Map: ACS 2009-2013
...
write.csv(acs.bg, file = "C:/Users/shields.mi417/Desktop/ACS_2015_BLKGRP.csv", row.names=F)
